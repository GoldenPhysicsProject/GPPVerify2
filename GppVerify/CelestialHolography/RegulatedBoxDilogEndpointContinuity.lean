...
/-!
# Continuity of the local dilogarithm series at the unit endpoint
...
permits the limit `x -> 1` to pass through the series.  This is the endpoint bridge
...
/-- In particular, the endpoint limit is the Basel constant. -/
